import{j as e,c as a,b as n,a4 as t}from"./chunks/framework.CXlYEdFK.js";const b=JSON.parse('{"title":"字符驱动模型","description":"","frontmatter":{},"headers":[],"relativePath":"tools/driver.md","filePath":"tools/driver.md","lastUpdated":1721298994000}'),s={name:"tools/driver.md"},i=t(`<h1 id="字符驱动模型" tabindex="-1">字符驱动模型 <a class="header-anchor" href="#字符驱动模型" aria-label="Permalink to &quot;字符驱动模型&quot;">​</a></h1><pre><code>1. __init
	1. 设备号(主, 次设备号)
		1. 设备号是由主,次设备号拼接而成.
