import{j as a,c as n,b as t,ag as s}from"./chunks/framework.CPnt7f93.js";const u=JSON.parse('{"title":"字符驱动模型","description":"","frontmatter":{},"headers":[],"relativePath":"tools/driver.md","filePath":"tools/driver.md","lastUpdated":1761215374000}'),i={name:"tools/driver.md"};function r(l,e,o,c,d,p){return t(),n("div",null,[...e[0]||(e[0]=[s(`<h1 id="字符驱动模型" tabindex="-1">字符驱动模型 <a class="header-anchor" href="#字符驱动模型" aria-label="Permalink to &quot;字符驱动模型&quot;">​</a></h1><pre><code>1. __init
	1. 设备号(主, 次设备号)
		1. 设备号是由主,次设备号拼接而成.
